...
const dateDiff = (date1, date2) => {
    return diffDays = parseInt((date1 - date2) / (1000*60*60*24), 10)
};
...
function init(data) {
    ...
    const shop = (prodList, tBill, lastProd) => {
        ...
        rl.question(`You can buy - ${productDetails}.\n Do you want to buy this item <Y/N>? `.yellow, function (option) {
            const regexYes = new Regex("y", "i"); // Use the RegExp built-in object type here as appropriate
            const regexNo = new Regex("n", "i"); // Use the RegExp built-in object type here as appropriate
